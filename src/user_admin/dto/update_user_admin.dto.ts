import { Matches, IsOptional, IsNumber, IsAlphanumeric, IsAscii, IsBoolean, IsEmpty, IsEmail, IsIn, IsString, MaxLength, MinLength, IsDateString, IsNotEmpty } from "class-validator"
